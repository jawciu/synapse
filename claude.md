...
- [README.md](/Users/ian/dev/synapse/README.md): public-facing project pitch with user quickstart, explicit web-first vs Telegram-first account flows, Telegram text/voice usage, architecture narrative, and local runbook
